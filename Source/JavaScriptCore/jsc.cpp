...
EncodedJSValue JSC_HOST_CALL functionCreateBuiltin(ExecState* exec)
{
    ...
    JSFunction* func = JSFunction::create(vm, createBuiltinExecutable(vm, source, Identifier::fromString(&vm, "foo"), ConstructorKind::None, ConstructAbility::CannotConstruct)->link(vm, source, nullptr), exec->lexicalGlobalObject());
